...
A_PI_0  = 70000;    %Intercept for Peak Intensity
B_PWL_0 = 529;      %Intercept for Peak Wavelength
C_FWHM_0= 11.5;        %Intercept for FWHM
...
S_B     = 0.25;          %Slope for Peak Wavelength
S_C     = 0.3;          %Slope for FWHM
